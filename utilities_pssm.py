...
def plot_pssm_as_logo(pssm, outfile=None, output=None, fade_negative=True, palette='Norman', h_line=None, h_label=None, x_label='Positions', y_label=None, title=None, figsize=(5, 2.5),remove_negatives=False):
